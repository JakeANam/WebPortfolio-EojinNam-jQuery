export const profile = [
    {
        ...
        languageTests:[
            {
                testName: "TOEIC",
                testedDate: "2018년 11월",
                grade: "825"
            },
            {
                testName: "JPT",
                testedDate: "2022년 10월",
                grade: "540"
            }
        ],
        lisencesAndCertificate:[
            {
                testName: "과정평가형 정보처리산업기사",
                testedDate: "2022년 12월",
            },
            {
                testName: "웹디자인기능사 (현, 웹디자인개발기능사)",
                testedDate: "2024년 4월",
            },
            {
                testName: "컴퓨터그래픽기능사 (필기 합격)",
                testedDate: "2025년 4월",
            }
        ],
        indexList: ['이름', '국적', '출생일', '주소', '취미']
    },
    {
        langCode: 'eng',
        name: 'Eo-jin Nam(Jake)',
        nationality: 'kor',
        birthday:'June 1993',
